...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Link to="https://gcashapp.page.link/?link=https://gcash.splashscreen/?redirect%3Dgcash%3A%2F%2Fcom.mynt.gcash%2Fapp%2F006300121300%3FappId%3D2170020233750696%2526page%253Dpages%252Fredirect%252Fredirect%253Fquery%253Dtype=redirect,code=ariel-campaign-2026&apn=com.globe.gcash.android&isi=520020791&ibi=com.globetel.gcash">Gcash sample URL</Link><br />
    </div>
  );
}