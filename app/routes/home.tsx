        ...
        <div className="absolute inset-x-0 bottom-0 flex flex-col items-center gap-4 pb-4">
          <div className="flex justify-center gap-10">
            <button
              ...
              className={`flex flex-col gap-1 items-center justify-center font-bold active:scale-95 transition-transform text-lg ${captureColorClass} ${uploading ? 'opacity-60 pointer-events-none' : ''}`}
            >
